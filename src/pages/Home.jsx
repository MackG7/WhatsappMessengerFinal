...
export default function Home() {
    ...
    return (
        <div className="wa-layout">
            ...
            {/* SIDEBAR WHATSAPP (con Drawer móvil) */}
            <Sidebar mobileOpen={mobileOpen} setMobileOpen={setMobileOpen} />

            {/* PANEL DERECHO */}
            <div className="chat-window">

                {/* HEADER DEL CHAT (incluye el botón hamburger SOLO en móvil) */}
                <div className="wa-chat-header">
                    ...
                    {selectedChat ? (
                        ...
                        <div className="header-name">WhatsApp Messenger</div>
                    )}
                </div>
                ...
                {selectedChat ? (
                    ...
                    <div className="welcome-screen">
                        ...
                        <div className="welcome-content">
                            <h1 className="welcome-title">WhatsApp Messenger</h1>
                            ...
                            <div className="welcome-features">
                                <div className="feature-item">
                                    ...
                                    <span>Chatea con tus contactos</span>
                                </div>
                                <div className="feature-item">
                                    <span className="feature-icon">👥</span>
                            ...
                            <div className="welcome-footer">
                                <span className="footer-text">
                                    Selecciona un chat o crea una nueva conversación
                                </span>
                            </div>
                        </div>
                    </div>
